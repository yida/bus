...
for i = 1 : 2
  for j = 1 : sample_num_div
    if sample_counter <= sample_num
      ...
      [fitted_x, fitted_y] = imu_polyfit(centralized_ts,...
                                          sample{sample_counter}.wy);
...
hold on;
[left_fitted_x, left_fitted_y] = imu_polyfit(imu_left_ts, imu_left_wy);
...
hold on;
[right_fitted_x, right_fitted_y] = imu_polyfit(imu_right_ts, imu_right_wy);
