...
%R = diag([0.01^2; 0.1^2; 0.01^2; 0; 0; 0]);
R = diag([1^2; 1^2; 0.01^2; 0.01^2]);
...
%for cnt = 2 : 2
  ...
  for chi_idx = 1 : size(Chi, 2)
    Chi(1, chi_idx) = Chi(1, chi_idx) + Chi(3, chi_idx) * delta_t;
    Chi(2, chi_idx) = Chi(2, chi_idx) + Chi(4, chi_idx) * delta_t;
  end 
