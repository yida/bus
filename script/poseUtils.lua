...
--rpy = torch.DoubleTensor({-3.07, -0.06, -0.18})
--qk = rpy2Quaternion(rpy)
--print(qk)
--R = Quaternion2R(qk)
--print(R)
--R1 = R:t()
...
--print(qk)
--g = torch.DoubleTensor({0,0,0,1})
--gt = QuaternionMul(QuaternionMul(qk, g), QInverse(qk))
--
--print(gt)


--q = torch.DoubleTensor({-0.9740, 0.0921, 0.0253, 0.2052})
